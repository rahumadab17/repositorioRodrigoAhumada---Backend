...
export const obtenerProductById = async (req, res) => {
    try {
        const productoPorId = await ProductDao.obtenerProductById(req.params.pid);
...
export const addNewProduct = async (req, res) => {
    try {
        ...
        const nuevoProducto = await ProductService.addNewProduct(nuevoProductoData);
...
export const updateProduct = async (req, res) => {
    try {
        const updProducto = await ProductDao.updateProduct(req.params.pid, req.body);
...
export const deleteProduct = async (req, res) => {
    try {
        const delProducto = await ProductDao.deleteProduct(req.params.pid);
